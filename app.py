...
from modules.ui_components import (
    ...
    render_venn_builder_page,
)
from pages.geo_deg import render_geo_deg_page
from pages.md_plot import render_md_plot_page
...
def main() -> None:
    ...
    if page_config.key == "venn_analysis":
        render_venn_builder_page(page_config)
        return
